...
void main() {
  ...
  LOG_printf(&LogEvent,"Execution Graph will display 7 events");
...
void SwiMainFunc(int arg0, int arg1) {
  ...
  /* To be able to open up both timer devices, the BIOS CLK manager */
  /* has been disabled using the configuration tool.                */
